...
export const CHARACTERS = [
  { id: 'blaze',  name: '烈焰',   color: 0xe53935, accent: 0xffffff, skin: 0xffcc99, hat: 'cap',     stats: { speed: 3, accel: 3, handling: 3, weight: 3 } },
  { id: 'zippy',  name: '追风',   color: 0x43a047, accent: 0xffffff, skin: 0xffcc99, hat: 'cap',     stats: { speed: 3, accel: 4, handling: 3, weight: 2 } },
  { id: 'bella',  name: '贝拉',   color: 0xf06292, accent: 0xfff176, skin: 0xffe0bd, hat: 'crown',   stats: { speed: 2, accel: 4, handling: 5, weight: 2 } },
  { id: 'toadly', name: '蘑菇头', color: 0x1e88e5, accent: 0xffffff, skin: 0xffe0bd, hat: 'mushroom',stats: { speed: 2, accel: 5, handling: 4, weight: 1 } },
  { id: 'rex',    name: '雷克斯', color: 0x2e7d32, accent: 0xff8f00, skin: 0x9ccc65, hat: 'horns',   stats: { speed: 5, accel: 1, handling: 2, weight: 5 } },
  { id: 'grumbo', name: '大块头', color: 0xfdd835, accent: 0x6a1b9a, skin: 0xffcc99, hat: 'cap',     stats: { speed: 4, accel: 2, handling: 2, weight: 4 } },
  { id: 'koopz',  name: '龟壳仔', color: 0x00acc1, accent: 0xfff9c4, skin: 0xaed581, hat: 'shell',   stats: { speed: 3, accel: 3, handling: 4, weight: 2 } },
  { id: 'dotty',  name: '波点',   color: 0x8e24aa, accent: 0xffeb3b, skin: 0xffe0bd, hat: 'bow',     stats: { speed: 2, accel: 4, handling: 4, weight: 1 } },
];
